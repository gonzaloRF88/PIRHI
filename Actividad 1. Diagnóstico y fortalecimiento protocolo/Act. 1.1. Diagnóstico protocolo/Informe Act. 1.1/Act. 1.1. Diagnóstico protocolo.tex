...
\begin{figure} [H]
  \includegraphics[width=.25\textwidth]{Logo/bg_gob_logo.png}
\end{figure}

\fontsize{15}{0} \selectfont{\textbf{"PLANIFICACIÓN DE LA INVERSIÓN EN REVESTIMIENTOS HÍDRICOS"}} \vspace*{.1in}\\
\fontsize{15}{0} \selectfont{FIC-R 2016}\vspace*{.1in}
\hspace*{.2in}

\fontsize{14}{0} \selectfont{Universidad de La Serena} \vspace*{.1in}\\
\fontsize{14}{0} \selectfont{\textbf{Región de Coquimbo}}
