...
\begin{tabular}{|l|l|l|}
\hline
\multicolumn{1}{|c|}{\textbf{Capa}} & \multicolumn{1}{c|}{\textbf{Geometría}} & \multicolumn{1}{c|}{\textbf{Descripción}}                                                                                                                                                                                                                              \\ \hline
\textbf{BARRERAS\_DESVIACION}       & Punto                                   & Representa las barreras de desviación de cada bocatoma, como atributo presenta el tipo de barrera caracterizado en terreno.                                                                                                                                            \\ \hline
\textbf{CANALES\_ADUCCION}          & Línea                                   & Representa al canal comprendido entre la barrera de desviación hasta el punto o compuerta de carga del canal. Dentro de sus atributos está el nombre del canal, longitud, tipo de captación, ribera, material, tipo de devolución, observaciones.                      \\ \hline
\textbf{COMPUERTAS\_CARGA}          & Punto                                   & Representa la obra en donde se entrega el agua desde bocatoma al canal para su distribución. En su información presenta nombre del canal, mecanismo de apertura, fuente del recurso hídrico, dimensiones de la sección donde se emplaza la compuerta.                  \\ \hline
\textbf{ESTRUCTURAS\_DISTRIBUCION}  & Punto                                   & Representa las obras destinadas a gestión y entrega (compuertas prediales, compuertas frontales y laterales, captación, marco partidor, taco). Dentro de sus atributos se encuentra al canal a la que pertenece, la función, tipo de obra, dimensiones, observaciones. \\ \hline
\textbf{REVESTIMIENTOS}             & Línea                                   & Representa el recorrido del canal, desde el km 0, correspondiente desde la compuerta de carga hasta el fin del canal. En sus atributos se presenta el revestimiento, tipo, material, forma, dimensiones, observación y su longitud.                                    \\ \hline
\textbf{OBSERVACIONES}              & Punto                                   & Representa puntos de interés dentro del trazado del canal, como: filtraciones, quebradas, contaminación, desbordes, entre otros.                                                                                                                                       \\ \hline
\end{tabular}
\end{table}
