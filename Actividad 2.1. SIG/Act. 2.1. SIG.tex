...
\item{\bfseries {Compuerta de carga o punto d entrega}}: corresponde a la estructura de control en donde se entrega el recurso hídrico, este puede ser una compuerta, captación o marco partidor.
...
lo que corresponde al canal de conducción y distribución del recurso se tomaron ...........
